Algorithm 5: MLP-Based Stacking Ensemble with True 5-Fold Cross-Validation
...
2. For each fold k = 1 to K:
       ...
       c. Compute feature standardization parameters using only the
          training folds and apply the same transformation to the
          validation fold.
       d. Train an MLP classifier using standardized features from
